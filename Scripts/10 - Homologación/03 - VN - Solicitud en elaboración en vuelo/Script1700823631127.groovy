...
WebUI.click(findTestObject('00 - VN - Opciones/Produccion VN/09 - Solicitar Elaboracion/GuardarSolicitud'))

WebUI.delay(8)

WebUI.takeScreenshot('C:\\Users\\PS13116\\OneDrive - Alliance\\Escritorio\\Katalon\\Katalon_Studio_Windows_64-8.6.5\\Evidencias\\Homologacion\\Solicitud Elaboracion\\SE01.png')

WebUI.click(findTestObject('00 - VN - Opciones/Produccion VN/09 - Solicitar Elaboracion/SalirSolicitud'))
...
WebUI.click(findTestObject('01 - Vuelo/BotonBuscar'))

WebUI.click(findTestObject('01 - Vuelo/AccesoPrimeraSolicitudEnVuelo'))

WebUI.click(findTestObject('00 - VN - Opciones/Produccion VN/09 - Solicitar Elaboracion/Solicitar'))

WebUI.delay(5)

WebUI.click(findTestObject('01 - Vuelo/AceptarSolicitudRecuperadaSeguida'))

WebUI.delay(10)

WebUI.takeScreenshot('C:\\Users\\PS13116\\OneDrive - Alliance\\Escritorio\\Katalon\\Katalon_Studio_Windows_64-8.6.5\\Evidencias\\Homologacion\\Solicitud Elaboracion\\SE02.png')
