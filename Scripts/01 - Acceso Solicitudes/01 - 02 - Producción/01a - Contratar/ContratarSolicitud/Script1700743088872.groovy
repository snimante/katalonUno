...
'Control de chasis'
WebUI.setText(findTestObject('01 - Solicitudes/01 - Buscador/Buscador/SeleccionarBuscasdor'), '4865708')
...
'Control de chasis'
WebUI.click(findTestObject('01 - Solicitudes/03 - Produccion/Contratar/Produccion'), FailureHandling.OPTIONAL)

'Control de chasis'
WebUI.click(findTestObject('01 - Solicitudes/03 - Produccion/Contratar/ContratarProduccion'))

WebUI.click(findTestObject('01 - Solicitudes/03 - Produccion/Contratar/ProduccionDos'), FailureHandling.OPTIONAL)
