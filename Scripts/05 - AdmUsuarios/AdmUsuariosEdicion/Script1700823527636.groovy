...
WebUI.setText(findTestObject('Administracion Usuarios/Consulta/InformarNombre'), 'Roberto')

WebUI.setText(findTestObject('Administracion Usuarios/Consulta/InformarApellido'), 'Avila')
...
WebUI.click(findTestObject('Administracion Usuarios/Permisos - Roles/Administracion'))

WebUI.click(findTestObject('Administracion Usuarios/Comunes/Guardar'))
