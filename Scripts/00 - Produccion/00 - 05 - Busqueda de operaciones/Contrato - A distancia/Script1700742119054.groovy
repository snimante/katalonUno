...
WebUI.setText(findTestObject('Produccion Busqueda Solicitudes/NumContratacion'), '202300046600')

WebUI.click(findTestObject('Produccion Busqueda Solicitudes/IrContrato'))

WebUI.click(findTestObject('Produccion Busqueda Solicitudes/firmaAdistancia'))

WebUI.delay(2)

WebUI.click(findTestObject('Produccion Busqueda Solicitudes/BotonesContratar/CancelarFirmaAdistancia'))

WebUI.click(findTestObject('Produccion Busqueda Solicitudes/firmaAdistancia'))

WebUI.click(findTestObject('Produccion Busqueda Solicitudes/BotonesContratar/GuardarFirmaAdistancia'))
