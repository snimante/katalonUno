...
WebUI.setText(findTestObject('00 - VN - Opciones/Produccion VN/08 - Solicitar/00 - Vendedor/NIFvendedor'), '38295818J')
...
WebUI.setText(findTestObject('01 - Vuelo/NifVerificacion'), NIFCompradorVO)
...
'Desde Producción finalizar el contrato\r\n'
WebUI.openBrowser('')
...
WebUI.setText(findTestObject('Avanza/Bueno/BusquedaDNI'), NIFCompradorVO)
