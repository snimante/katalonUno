...
WebUI.callTestCase(findTestCase('00 - Produccion/00 - 01 - Vehiculo Nuevo/04 - Empresas/00 - Funcionalidades Unitarias/02 - 02b - Selec tipoCliente tipoProductoEmpresa'), 
    [('DNIProfesional') : '85970715G'], FailureHandling.CONTINUE_ON_FAILURE)

println('Fin Seleccionar Cliente Profesional Leasing')

WebUI.callTestCase(findTestCase('00 - Produccion/00 - 01 - Vehiculo Nuevo/04 - Empresas/00 - Funcionalidades Unitarias/02 - 02a - SeleccionarTipoClienteEmpresa'), 
    [('DNIProfesional') : '74557467T'], FailureHandling.CONTINUE_ON_FAILURE)

println('Fin de informar Titular Profesional con Producto Leasing')

WebUI.callTestCase(findTestCase('00 - Produccion/00 - 01 - Vehiculo Nuevo/04 - Empresas/00 - Funcionalidades Unitarias/99 - 03 - Condicion estado Empresa'), 
    [:], FailureHandling.CONTINUE_ON_FAILURE)

println('Fin de cambio de estado EA - DP ')

WebUI.callTestCase(findTestCase('00 - Produccion/00 - 01 - Vehiculo Nuevo/04 - Empresas/00 - Funcionalidades Unitarias/99 - 05 - VerificaciónDocumentalEmpresa'), 
    [:], FailureHandling.CONTINUE_ON_FAILURE)

println('Validaciópn documental y servicio de IPIS')

WebUI.callTestCase(findTestCase('00 - Produccion/00 - 01 - Vehiculo Nuevo/04 - Empresas/00 - Funcionalidades Unitarias/Validacion de facturaEmpresa'), 
    [:], FailureHandling.CONTINUE_ON_FAILURE)

println('Fin Seleccionar Rellenar Factura')
