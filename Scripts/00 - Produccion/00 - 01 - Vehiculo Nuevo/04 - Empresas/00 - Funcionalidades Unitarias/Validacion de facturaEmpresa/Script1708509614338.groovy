...
WebUI.setText(findTestObject('01 - Solicitudes/01 - Buscador/Filtros Busqueda/CampoNif'), GlobalVariable.GlobalEmpresa)
...
WebUI.setText(findTestObject('01 - Solicitudes/02 - Aceptación/rellenarFactura/base'), '14314.12')
...
WebUI.click(findTestObject('01 - Solicitudes/02 - Aceptación/rellenarFactura/gridSalir'))

WebUI.click(findTestObject('01 - Solicitudes/02 - Aceptación/rellenarFactura/aceptarFactura'))

WebUI.click(findTestObject('01 - Solicitudes/02 - Aceptación/rellenarFactura/aceptarCamposObligatorios'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('01 - Solicitudes/02 - Aceptación/rellenarFactura/aceptarFactura'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('01 - Solicitudes/02 - Aceptación/rellenarFactura/avisoFacturaOK'), FailureHandling.OPTIONAL)
