...
WebUI.setText(findTestObject('01 - Vuelo/NifVerificacion'), GlobalVariable.GlobalEmpresa)
...
'Verificación Documental'
WebUI.click(findTestObject('02 - Producción - Verificación/00 - Documentación/Empresa/CIFempresa'))
