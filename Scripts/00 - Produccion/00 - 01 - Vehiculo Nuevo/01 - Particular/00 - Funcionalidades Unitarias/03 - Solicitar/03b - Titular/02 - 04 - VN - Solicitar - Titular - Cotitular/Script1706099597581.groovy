...
WebUI.click(findTestObject('00 - VN - Opciones/Produccion VN/08 - Solicitar/02 - Avalista/00 - DatosCliente/RolAvalista'))

WebUI.click(findTestObject('00 - VN - Opciones/Produccion VN/08 - Solicitar/02 - Avalista/00 - DatosCliente/RolCotiularAvalista'))
