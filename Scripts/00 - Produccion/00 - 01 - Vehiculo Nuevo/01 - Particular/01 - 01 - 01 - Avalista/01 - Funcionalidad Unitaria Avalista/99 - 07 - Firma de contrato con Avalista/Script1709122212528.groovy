...
'15 - Firmar contratación.'
WebUI.setText(findTestObject('00 - VN - Opciones/Produccion VN/01 - Comunes/01 - SelecRedTipoVehiculo/SelecRed'), findTestData(
        'Centro 12000/12000').getValue(1, 1))
...
'15 - Firmar contratación.'
WebUI.setText(findTestObject('Produccion Busqueda Solicitudes/nifContratacion'), GlobalVariable.GlobalDNITituAvalista)
