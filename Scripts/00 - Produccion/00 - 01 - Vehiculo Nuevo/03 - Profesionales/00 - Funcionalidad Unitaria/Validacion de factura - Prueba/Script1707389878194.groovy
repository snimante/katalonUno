...
WebUI.setText(findTestObject('01 - Solicitudes/01 - Buscador/Filtros Busqueda/CampoNif'), '75959315K')
...
WebUI.setText(findTestObject('01 - Solicitudes/02 - Aceptación/rellenarFactura/base'), '27272.31')
