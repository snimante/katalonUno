...
WebUI.setText(findTestObject('01 - Solicitudes/01 - Buscador/Filtros Busqueda/CampoNif'), '51908610W')

'Funcionalidad Aceptar Solicitud - 2 - Buscador de solicitudes'
WebUI.click(findTestObject('01 - Solicitudes/01 - Buscador/Buscador/BuscarSolicitud'))

while (WebUI.verifyElementVisible(findTestObject('01 - Solicitudes/06 - Condiciones/solicitudAC'), FailureHandling.CONTINUE_ON_FAILURE) == 
true) {
    'Funcionalidad Aceptar Solicitud - 2 - Buscador de solicitudes'
    WebUI.click(findTestObject('01 - Solicitudes/01 - Buscador/Buscador/BuscarSolicitud'))
