...
WebUI.setText(findTestObject('02 - Producción - Verificación/BotonesVerificacion/BusquedaVerificacion'), '4846093')
...
'12 - Verificar Documentos - Mensaje en solicitud'
WebUI.click(findTestObject('02 - Producción - Verificación/MensajesVerificación/AceptarMensajeAlerta'), FailureHandling.OPTIONAL)
